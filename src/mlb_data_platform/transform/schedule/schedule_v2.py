"""Schedule.schedule() transformation - Refactored with base_v2.
...
class ScheduleTransformV2(BaseTransformation):
    """Refactored schedule transformation using extraction registry pattern.
